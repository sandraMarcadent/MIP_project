...
def get_outputs(inputs, network="tensorflow", skip=False):
    ...
    with tf.variable_scope("Model") as scope:
        ...
        prob_b_from_class_i = classifyer(fake_images_b, name="o_B")
    ...
    return {
        ...
        'prob_b_from_class_i':prob_b_from_class_i,        '
...
def classifyer(inputcl, name="discriminator"):
    with tf.variable_scope(name):
        f = 4

        padw = 2

        flip_cl = flip_gradient(inputcl)
        
        pad_input = tf.pad(flip_cl, [[0, 0], [padw, padw], [
            padw, padw], [0, 0]], "CONSTANT")
        o_c1 = general_conv2d(pad_input, ndf, f, f, 2, 2,
                                     0.02, "VALID", "c1", do_norm=False,
                                     relufactor=0.2)
        ...
        pad_o_c4 = tf.pad(o_c4, [[0, 0], [padw, padw], [
            padw, padw], [0, 0]], "CONSTANT")
        o_c5 = general_conv2d(
            pad_o_c4, 6, f, f, 1, 1, 0.02, "VALID", "c5",
            do_norm=False, do_relu=False)
