...
def get_outputs(inputs, network="tensorflow", skip=False):
    ...
    with tf.variable_scope("Model") as scope:
        ...
        if network == "pytorch":
            ...
            current_generator = build_generator_resnet_9blocks_resizeconv_tf
        else:
            raise ValueError(
...
def build_generator_resnet_9blocks_tf(inputgen, name="generator", skip=False):
    with tf.variable_scope(name):
            ...
            o_c5 = general_deconv2d(
                ...
                "SAME", "c5")
            o_c6 = general_conv2d(o_c5, IMG_CHANNELS, f, f, 1, 1,
                                         0.02, "SAME", "c6",
...
def build_generator_resnet_9blocks_resizeconv_tf(inputgen, name="generator", skip=False):
    with tf.variable_scope(name):
            f = 7
            ks = 3
            padding = "REFLECT"
            ...
            o_c4 = general_resizeconv2d(o_r9, IMG_HEIGHT/2, IMG_WIDTH/2, ngf * 2, ks, ks, 0.02,
                "SAME", "c4")
            o_c5 = general_resizeconv2d(o_c4, IMG_HEIGHT, IMG_WIDTH, ngf, ks, ks, 0.02,
                "SAME", "c5")        
            o_c6 = general_conv2d(o_c5, IMG_CHANNELS, f, f, 1, 1,
                                         0.02, "SAME", "c6",
                                         do_norm=False, do_relu=False)
...
def patch_discriminator(inputdisc, name="discriminator"):
    with tf.variable_scope(name):
        ...
        o_c1 = general_conv2d(patch_input, ndf, f, f, 2, 2,
                                     0.02, "SAME", "c1", do_norm="False",
                                     relufactor=0.2)
        o_c2 = general_conv2d(o_c1, ndf * 2, f, f, 2, 2,
                                     0.02, "SAME", "c2", relufactor=0.2)
        o_c3 = general_conv2d(o_c2, ndf * 4, f, f, 2, 2,
                                     0.02, "SAME", "c3", relufactor=0.2)
        o_c4 = general_conv2d(o_c3, ndf * 8, f, f, 2, 2,
                                     0.02, "SAME", "c4", relufactor=0.2)
        o_c5 = general_conv2d(
