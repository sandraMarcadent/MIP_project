...
def get_outputs(inputs, network="tensorflow", skip=False):
    ...
    hat_input_a = inputs['hat_input_a']
    hat_input_b = inputs['hat_input_b']
    ...
    with tf.variable_scope("Model") as scope:
        ...
        hat_output_a = current_discriminator(hat_input_a, "d_A")
        hat_output_b = current_discriminator(hat_input_b, "d_B")
    ...
    return {
        ...
        'hat_output_a': hat_output_a,
        'hat_output_b': hat_output_b
    }
