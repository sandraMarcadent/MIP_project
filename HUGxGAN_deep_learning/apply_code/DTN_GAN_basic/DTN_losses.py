...
def dmnn_loss(prob_class_A, prob_class_B):
    return (tf.reduce_mean(tf.squared_difference(prob_class_A, 1)) +
            tf.reduce_mean(tf.squared_difference(prob_class_B, 0))) * 0.5
